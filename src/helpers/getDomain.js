...
export const getDomain = () => {
  const prodUrl = 'https://sopra-fs23-group-38-server.oa.r.appspot.com/' // TODO: insert your prod url for server (once deployed)
  const devUrl = 'https://sopra-fs23-group-38-server.oa.r.appspot.com/'
