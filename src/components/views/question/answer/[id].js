...
import {getTopComments, insertComment} from "@/helpers/comment";
...
export const getServerSideProps = async (context) => {
  ...
  const initAnswer = response1.data
  const comment = response2.data?.comments
...
const AnswerComments = ({ comment, initAnswer }) => {
  useAuth()
          ...
          >
            <Row>
              <Col span={3}>
                ...
                <p className={styles.name} style={{ fontSize: '12px', marginTop: '4px' }}>{ answer.nickname }</p>
              </Col>
                ...
                return <div key={comment.comment.id}>
                  <Row>
                    <Col span={3}>
                      ...
                      <p className={styles.name} style={{ fontSize: '12px', marginTop: '4px' }}>{comment.commentator.nickname}</p>
                    </Col>
