import styles from "components/views/styles/question.create.module.scss";
...
const Answer = ({ question }) => {
    ...
    const onFinish = (values) => {
        ...
        const response = requests.post(`/answer/newAnswer?which_question=${id}&content=${values['content']}`).then(
            (
                response =>{
