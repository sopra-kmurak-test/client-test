            ...
            <div className={styles.main}>
                ...
                >
                    <Row>
                        ...
                        <Col>
                            <Button style={{ backgroundColor: '#6F3BF5' }} disabled={isTrans}  onClick={translateTitle} type={"primary"}>Translate Question</Button>
                        </Col>
                        ...
                        return <div key={answer.answer.id}>
                            <Row>
                                <Col span={3}>
                                    ...
                                    { user && user.username === answer.answererNickName ? <div>
                                        <p className={styles.name} style={{ fontSize: '12px', marginTop: '4px' }}>{answer.answererNickName}</p>
                                    </div> : <div onClick={() => router.push({
                                        pathname: "/chat", query: { fromUserId: user.id, toUserId: answer.answererId }
