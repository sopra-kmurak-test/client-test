        ...
        <Card style={{ width: '756px', padding: 0 }} bodyStyle={{ padding: '16px' }}>
          <Row>
            <Col span={18} style={{ display: 'flex', alignItems: 'center'}}>
              <span style={{ whiteSpace: "nowrap", overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '512px' }} onClick={() => { router.push(`/question/${article.id}`) }} className={styles.title}>{article.title}</span>
            </Col>
            ...
            <Col span={3}>
              ...
              <p className={styles.date}>{moment(article.createTime).format('ll')}</p>
            </Col>
          </Row>
        </Card>
      </div>
